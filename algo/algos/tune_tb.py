...
class TUNE_TB(object):
    ...
    def select_tuned_action(self, state, tar_replay_buffer, batch_size, tune_steps=10):
        ...
        replay buffer for a few gradient steps, select an action with the tuned
        policy, then discard all cloned components.
        ...
        for _ in range(tune_steps):
            ...
            with torch.no_grad():
                ...
                value_target = tar_reward + tar_not_done * self.discount * (
